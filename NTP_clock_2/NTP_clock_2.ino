...
// =======================================================================
const char* ssid     = "b";     // SSID of local network
const char* password = "tanyaandre";   // Password on network
// =======================================================================
void setup() 
{
  Serial.begin(115200);
...
void loop()
{
  if(updCnt<=0) { // every 10 scrolls, ~450s=7.5m
    ...
    printStringWithShift("; EWOK SEDANG MELIHAT DATA WAKTU INDONESIA BAGIAN BARAT",60);
    getTime();
